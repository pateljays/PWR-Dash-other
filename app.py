...
df.rename(columns={'Oral Hygiene-1': 'Oral Hygiene - New Logic',
                   'Caries_Risk': 'Caries Risk', 'Diabetes A1c': 'Diabetes A1c - New Logic',
                   'Self_Image': 'Self Image', 'Blood Pressure': 'Blood Pressure - New Logic',
                   'Caries_Lesions': 'Caries Lesions', 'Perio Inflamation': 'Perio Inflammation - New Logic',
                   'Perio Pockets 2': 'Perio Pockets - New Logic', 'Perio Diagnosis':'Perio Diagnosis - New Logic'}, inplace=True)
# 'Treatment Completion Date':'Date'

variables = ['Overall Performance', 'Perio Diagnosis - New Logic',
             'Blood Pressure - New Logic','Perio Inflammation - New Logic',
             'Perio Pockets - New Logic','Diabetes A1c - New Logic','Oral Hygiene - New Logic',
             'Caries Risk','Caries Lesions','Anxiety','Chewing','Speaking',
             'Comfort','Self Image', 'Smoking']
